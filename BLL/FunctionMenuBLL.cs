...
namespace YDIOTSvr.DataLayer.BLL
{
	...
	/// 功能菜单权限
	/// </summary>
	public partial class FunctionMenuBLL
	{
        private readonly FunctionMenuDAL dal = new FunctionMenuDAL();
		public FunctionMenuBLL()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<FunctionMenuEntity> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<FunctionMenuEntity> DataTableToList(DataTable dt)
		{
			List<FunctionMenuEntity> modelList = new List<FunctionMenuEntity>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				FunctionMenuEntity model;
