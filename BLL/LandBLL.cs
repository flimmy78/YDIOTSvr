...
namespace YDIOTSvr.DataLayer.BLL
{
	...
	/// 描述需要自动灌溉或者
	/// </summary>
	public partial class LandBLL
	{
        private readonly LandDAL dal = new LandDAL();
		public LandBLL()
		{}
		#region  BasicMethod
		...
		{
			return dal.DeleteList(Land_IDlist );
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LandEntity> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LandEntity> DataTableToList(DataTable dt)
		{
			List<LandEntity> modelList = new List<LandEntity>();
