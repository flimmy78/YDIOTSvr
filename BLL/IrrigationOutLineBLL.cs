...
namespace YDIOTSvr.DataLayer.BLL
{
	...
	/// 用经纬度坐标描述灌区
	/// </summary>
	public partial class IrrigationOutLineBLL
	{
        private readonly IrrigationOutLineDAL dal = new IrrigationOutLineDAL();
		public IrrigationOutLineBLL()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<IrrigationOutLineEntity> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IrrigationOutLineEntity> DataTableToList(DataTable dt)
		{
			List<IrrigationOutLineEntity> modelList = new List<IrrigationOutLineEntity>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IrrigationOutLineEntity model;
