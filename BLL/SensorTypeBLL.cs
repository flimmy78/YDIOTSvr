...
namespace YDIOTSvr.DataLayer.BLL
{
	...
	/// 水泵的表。通讯配置规
	/// </summary>
	public partial class SensorTypeBLL
	{
        private readonly SensorTypeDAL dal = new SensorTypeDAL();
		public SensorTypeBLL()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<SensorTypeEntity> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<SensorTypeEntity> DataTableToList(DataTable dt)
		{
			List<SensorTypeEntity> modelList = new List<SensorTypeEntity>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				SensorTypeEntity model;
