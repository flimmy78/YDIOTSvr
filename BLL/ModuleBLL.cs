...
namespace YDIOTSvr.DataLayer.BLL
{
	...
	{
        private readonly ModuleDAL dal = new ModuleDAL();
		public ModuleBLL()
		{}
		#region  BasicMethod
		/// <summary>
		...
		{
			return dal.DeleteList(Md_IDlist );
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<StationEntity> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<StationEntity> DataTableToList(DataTable dt)
		{
			List<StationEntity> modelList = new List<StationEntity>();
