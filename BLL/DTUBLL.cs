...
namespace YDIOTSvr.DataLayer.BLL
{
	...
	/// 执行器类型表
	/// </summary>
	public partial class DTUBLL
	{
        private readonly DTUDAL dal = new DTUDAL();
		public DTUBLL()
		{}
		#region  BasicMethod
		/// <summary>
		...
		{
			return dal.DeleteList(DTU_IDlist );
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DTUEntity> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DTUEntity> DataTableToList(DataTable dt)
		{
			List<DTUEntity> modelList = new List<DTUEntity>();
