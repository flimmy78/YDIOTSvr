...
namespace YDIOTSvr.DataLayer.BLL
{
	...
	/// 水泵的表。通讯配置规
	/// </summary>
	public partial class StatisticsItemBLL
	{
        private readonly StatisticsItemDAL dal = new StatisticsItemDAL();
		public StatisticsItemBLL()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<StatisticsItemEntity> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<StatisticsItemEntity> DataTableToList(DataTable dt)
		{
			List<StatisticsItemEntity> modelList = new List<StatisticsItemEntity>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				StatisticsItemEntity model;
