...
namespace YDIOTSvr.DataLayer.BLL
{
	...
	{
        private readonly UserLogDAL dal = new UserLogDAL();
		public UserLogBLL()
		{}
		#region  BasicMethod
		...
		{
			return dal.DeleteList(Ur_IDlist );
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<UserLogEntity> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<UserLogEntity> DataTableToList(DataTable dt)
		{
			List<UserLogEntity> modelList = new List<UserLogEntity>();
