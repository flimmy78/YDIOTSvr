...
{
	/// <summary>
    /// 数据访问类:StatisticsItemForUasgeDAL
	/// </summary>
	public partial class StatisticsItemForUasgeDAL
	{
		public StatisticsItemForUasgeDAL()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "statisticsItemForUasge"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from statisticsItemForUasge");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from statisticsItemForUasge ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,SI_ID,Usage_ID ");
			strSql.Append(" FROM statisticsItemForUasge ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,SI_ID,Usage_ID ");
			strSql.Append(" FROM statisticsItemForUasge ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from statisticsItemForUasge T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "statisticsItemForUasge";
