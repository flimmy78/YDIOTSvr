...
namespace YDIOTSvr.DataLayer.DAL
{
	...
	/// 数据访问类:ModuleTypeDAL
	/// </summary>
	public partial class ModuleTypeDAL
	{
		...
		/// 是否存在该记录
		/// </summary>
		public bool Exists(string Mp_ID)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from Module_type");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Module_type(");
			strSql.Append("Mp_ID,Mp_ID_from_recall,Mp_name,Mp_manufacture,Mp_analog_input_number,Mp_switching_input_number,Mp_switching_output_number,Mp_Counter_number)");
			...
			parameters[0].Value = model.Mp_ID;
			parameters[1].Value = model.Mp_ID_from_recall;
			parameters[2].Value = model.Mp_name;
			parameters[3].Value = model.Mp_manufacture;
			parameters[4].Value = model.Mp_analog_input_number;
			parameters[5].Value = model.Mp_switching_input_number;
			parameters[6].Value = model.Mp_switching_output_number;
			parameters[7].Value = model.Mp_Counter_number;
		...
		/// 删除一条数据
		/// </summary>
		public bool Delete(string Mp_ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Module_type ");
			strSql.Append(" where Mp_ID=@Mp_ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@Mp_ID", SqlDbType.NVarChar,50)			};
			parameters[0].Value = Mp_ID;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Mp_ID,Mp_ID_from_recall,Mp_name,Mp_manufacture,Mp_analog_input_number,Mp_switching_input_number,Mp_switching_output_number,Mp_Counter_number ");
			strSql.Append(" FROM Module_type ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Module_type T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Module_type";
